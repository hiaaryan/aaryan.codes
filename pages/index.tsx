		...
		<>
			...
			<div className="select-none font-mono">
				...
				<div id="work" className="p-2 lg:p-36 bg-black select-none font-mono h-auto lg:h-screen w-auto">
					<a href="/projects/athletico" className="relative w-full h-full hover:cursor-pointer">
				...
				<div className="p-2 lg:p-36 bg-black select-none font-mono h-auto lg:h-screen w-auto">
					<a href="/projects/beep-beep" className="relative w-full h-full hover:cursor-pointer">
				...
				<div className="p-2 lg:p-36 bg-black select-none font-mono h-auto lg:h-screen w-auto">
					<a href="/projects/flotek" className="relative w-full h-full hover:cursor-pointer">
				...
				<div className="p-2 lg:p-36 bg-black select-none font-mono h-auto lg:h-screen w-auto">
					<a href="/projects/tbim" className="relative w-full h-full hover:cursor-pointer">
