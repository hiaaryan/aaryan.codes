          ...
          <div>
            <div>
              <div className="mb-6 flex items-center">
                ...
                <h1 className="text-gray-400 font-black text-4xl lg:text-5xl">
                  hello, <br />
                  i am <span className="text-black">aaryan</span>.
                </h1>
              </div>
              
              <div className="text-sm lg:text-base">👨🏻‍💼 i am a digital marketer specializing in brand design and management.</div>
              <div className="hidden lg:block text-sm lg:text-base">👨🏻‍💻 i also develop webapps & native apps with php, js & tailwind.</div>
            </div>

            <div className="text-xs lg:text-base absolute bottom-8 flex justify-center gap-6">
